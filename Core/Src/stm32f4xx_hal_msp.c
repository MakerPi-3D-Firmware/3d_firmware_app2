...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = GD32_TEMP_B_Pin|GD32_TEMP_BED_Pin|GD32_TEMP_E_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, GD32_TEMP_B_Pin|GD32_TEMP_BED_Pin|GD32_TEMP_E_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA15     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = GD32_FAN_NOZ_E_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(GD32_FAN_NOZ_E_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = GD32_FAN_NOZ_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(GD32_FAN_NOZ_B_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM10_MspPostInit 0 */
    ...
    PF6     ------> TIM10_CH1
    */
    GPIO_InitStruct.Pin = GD32_STEERING_ENGINE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM10;
    HAL_GPIO_Init(GD32_STEERING_ENGINE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM11_MspPostInit 0 */
    ...
    PB9     ------> TIM11_CH1
    */
    GPIO_InitStruct.Pin = GD32_BUZZER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM11;
    HAL_GPIO_Init(GD32_BUZZER_GPIO_Port, &GPIO_InitStruct);
